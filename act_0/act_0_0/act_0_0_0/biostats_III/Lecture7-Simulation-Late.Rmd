...
## Set a sample size
n = 30
## Set a number of repititions
K = 1000
## Initialize the output
slopes = NULL

for(i in 1:K){
  ## Specify the population: I need (y,X)
  X = rexp(n,rate = 5)
  ## Generate y based on a SLR model
  # y = systematic / mean + error / residual
  # Under Gaussian residuals
  #y = 1.6 + 0.97 * X + rnorm(n,mean=0,sd=1)
  # Under non-gaussian residuals
  y = 1.6 + 0.97 * X + scale(rchisq(n,df=1))
  # Fit the SLR
  fit = lm(y~X)
  # Save slope
